        ...
        >
          <GlassCard className="relative p-6 border-emerald-500/40 shadow-2xl shadow-emerald-500/20 bg-background/80 backdrop-blur-xl">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-semibold text-foreground text-lg mb-1.5 tracking-tight">
                  {t.onboarding.title}
                </h3>
                ...
                <Button
                  size="sm"
                  className="w-full bg-emerald-500 hover:bg-emerald-600 rounded-full text-white shadow-md shadow-emerald-500/20 transition-transform active:scale-95"
                  onClick={() => setIsVisible(false)}
                >
                  {t.onboarding.gotIt}
                </Button>
